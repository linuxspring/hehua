                ...
                <form method="post">
                    <div class="form-group">
                        <div class="col-xs-12  ">
                            <div class="input-group">
                                ...
                                <input type="text" id="usernamePost" name="usernamePost" class="hidden"value="@zq.gpgc"/>
                                <span class="input-group-addon" name="usernamePost">@zq.gpgc</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-xs-4 col-xs-offset-4 ">
                            <button id="loginBtn"  class="btn btn-sm btn-info"><span
                    ...
                    <div class="form-group">
                        <div class="col-xs-6 link">
                            <p class="text-center remove-margin">
                                <small>XXX供电局，版权所有</small>
                            </p>
                        </div>
                        <div class="col-xs-6 link">
                            <p class="text-center remove-margin">
                                <small>技术支持热线：XXXXXX</small>
                            </p>
                        </div>
